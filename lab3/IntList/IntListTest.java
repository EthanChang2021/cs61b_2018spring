...
public class IntListTest {
    ...
    public void testReverse(){
        ...
        assertEquals(IntList.reverse(B), null); //method handles a null input properly.
        assertEquals(exp, IntList.reverse(A));  //the function returns a reversed list.
        assertNotEquals(A, IntList.of(1, 2, 3, 4, 5));  //the function is destructive.
